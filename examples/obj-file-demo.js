...
export class Obj_File_Demo extends Component {                           // **Obj_File_Demo** show how to load a single 3D model from an OBJ file.
  ...
  init() {                               // Load the model file:
    ...
    // Bump mapped:
    this.bumps = {
      shader: new defs.Fake_Bump_Map(1), color: color(.5, .5, .5, 1),
      ambient: .3, diffusivity: .5, specularity: .5, texture: new Texture("assets/stars.png")
    };
  }
