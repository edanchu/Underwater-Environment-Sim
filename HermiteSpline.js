...
class HermiteSpline extends Shape {
    ...
    generateMesh() {
        ...
        this.arrays.normal = [];
        this.indices = [];
        let subdivisions = 5 * (this.controlPoints.length - 1), resolution = 25;
    ...
    copy_onto_graphics_card_new_vertices(context, selection_of_arrays = Object.keys(this.arrays), write_to_indices = true) {
        ...
        const write = (target, data) => gl.bufferData(target, data, gl.STATIC_DRAW);
...
function getCircle(point, normal, segments, radius = 0.04) {
